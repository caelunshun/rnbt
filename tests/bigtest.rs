...
fn bigtest() {
    ...
    assert_eq!(c.get("doubleTest").unwrap().double().unwrap().value, 0.49312871321823148);
    assert_eq!(c.get("floatTest").unwrap().float().unwrap().value, 0.49823147058486938);
    assert_eq!(c.get("longTest").unwrap().long().unwrap().value, 9223372036854775807);
